...
describe("osc.sawtooth", () => {
    ...
    it("should execute with default config", () => {
        ...
        let result = sawtooth.execute({ fields: { freq: 1.0 }, untagged: [] }, config, context);
        ...
        // Next step
        result = sawtooth.execute({ fields: { freq: 1.0 }, untagged: [] }, config, context);
    ...
    it("should handle input frequency override", () => {
        ...
        const config = { fields: {}, untagged: [] };
        const inputs = { fields: { freq: 2.0 }, untagged: [] }; // Override with 2Hz
    ...
    it("should wrap phase correctly", () => {
        ...
        const result = sawtooth.execute({ fields: { freq: 1.0 }, untagged: [] }, config, context);
    ...
    it("should output random values for high frequency", () => {
        ...
        const result1 = sawtooth.execute({ fields: { freq: 60.0 }, untagged: [] }, config, context);
        const result2 = sawtooth.execute({ fields: { freq: 60.0 }, untagged: [] }, config, context);
